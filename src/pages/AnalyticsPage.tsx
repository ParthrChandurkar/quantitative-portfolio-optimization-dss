...
import { WalkForwardTab } from './Analytics/WalkForwardTab'
...
export function AnalyticsPage() {
  const [activeTab, setActiveTab] = useState<'overview' | 'walk-forward'>('overview')
  ...
  return <>
    ...
    <nav className="analytics-tabs" aria-label="Analytics views"><button className={activeTab === 'overview' ? 'active' : ''} onClick={() => setActiveTab('overview')}>Snapshot analytics</button><button className={activeTab === 'walk-forward' ? 'active' : ''} onClick={() => setActiveTab('walk-forward')}>Walk-forward</button></nav>
    {activeTab === 'walk-forward' ? <WalkForwardTab portfolioId={portfolioId}/> : <>
