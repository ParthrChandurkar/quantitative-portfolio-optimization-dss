...
- Phase 9B removes the frontend fixture path and renders this loaded data through React Query. Its original ₹1,000,000 walkthrough selected six of the 49 stocks, used stored fundamental beta values for a market-crash scenario, produced a 249-date replay and 30-point frontier, and generated a valid PDF. Phase 9C subsequently proved that all 249 replay dates overlapped the fit window, so its ₹1,507,469.92 result must not be treated as out-of-sample evidence.
- Phase 9C enforces a genuine temporal split. The corrected real-data run estimated on 252 dates from 2024-01-23 through 2025-01-29 and evaluated on 249 disjoint dates from 2025-01-30 through 2026-01-30. The fitted six-stock portfolio changed ₹1,000,000 to ₹1,101,423.96 out of sample, with 10.3141% annualized realized return, 15.2203% realized volatility, 0.6777 realized Sharpe, and -13.2597% maximum drawdown. No market-data table rows changed; see `docs/methodology-notes.md`.
